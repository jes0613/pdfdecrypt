...
namespace Encryption
{
    class Program
    {
        ...
        {
            // Our inputs in ASCII
            string pdfFilePath = ("C:/Users/jesar/Box/BYU/WS 2021/IS 414/Lab 1/Encryption and Hashing Lab Files/PO-encrypted.pdf");
            byte[] bytespdf = System.IO.File.ReadAllBytes(pdfFilePath);
            string password = "drpepperissuperior";
            string plaintext =  BitConverter.ToString(bytespdf).Replace("-", "");
            ...
            //byte[] messagebytes = StringToByteArray(decryptedMessage);
        ...
        public static byte[] Decrypt(byte[] cipherbytes, string password)
        {
            ...
            // We're going to read the decrypted information from the cryptostream using a bytereader
            BinaryReader bReader = new BinaryReader(cryptStream);
            byte[] decryptedText = bReader.ReadBytes(2000000); // Read all the way to the end and output as a string
